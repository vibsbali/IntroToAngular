...
namespace AngularApp.ApiControllers
{
    public class EmployeeController : ApiController
    {
        private readonly List<Employee> employees = new List<Employee>
        {
            ...
            new Employee { Id = 1008, Name = "Akhil Clarke", Gender = "Male", Salary = 4000.00m, DepartmentId = 1003  },
            ...
            new Employee { Id = 1011, Name = "Francis Aurera", Gender = "Male", Salary = 1000.00m, DepartmentId = 1022  },
            new Employee { Id = 1012, Name = "Audrey Guerara", Gender = "Female", Salary = 5000.00m, DepartmentId = 3071  },
            new Employee { Id = 1013, Name = "Casey	 Robinson", Gender = "Male", Salary = 4000.00m, DepartmentId = 1003  },
            new Employee { Id = 1014, Name = "Samantha Abraham", Gender = "Female", Salary = 3000.00m, DepartmentId = 1004  },
